...
public class SharkSandbox {
	...
	public static void main(String[] args) throws SharkKBException {
		...
		photoBook =
		        catalog.createSemanticTag("Book: Portrait Photography",
		                "http://youtube.com/photoBook");
		camera =
		        catalog.createSemanticTag("Camera: SONY IS345BRG200",
		                "http://youtube.com/SONYis345");
		exhibition =
		        catalog.createSemanticTag("Exhibition: Photos of NY", "http://youtube.com/photony");
		ipod = catalog.createSemanticTag("Ipod: apple123ipod", "http://youtube.com/apple123");
		pcMonitor = catalog.createSemanticTag("PC Monitor: bzz12", "http://youtube.com/bzz12");
		photography =
		        catalog.createSemanticTag("Photography", "http://en.wikipedia.org/wiki/Photography");
		devices =
		        catalog.createSemanticTag("Electro Devices", "http://en.wikipedia.org/wiki/Devices");
		...
		System.out.println("Item: " + camera.getName() + "\t[" + camera.getSI()[0]
		        + "] \nis in the world(s) of: ");
		Enumeration<SNSemanticTag> cameraBelongsTo = camera.targetTags(isInTheWorldOf);
		...
		Enumeration<SNSemanticTag> photoWorldTags = photography.sourceTags(isInTheWorldOf);
		...
		Enumeration<SNSemanticTag> electroTags = devices.sourceTags(isInTheWorldOf);
